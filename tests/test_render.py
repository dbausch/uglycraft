...
# Pure helper: (record, orient, open_channels) -> sprite key or
...
def test_border_sprite_locked_opened():
    ...
    assert border_exit_sprite(('locked', 'red', 'border_door_0'), 'h',
                              opened) == 'door_open_h'
    assert border_exit_sprite(('locked', 'red', 'border_door_0'), 'v',
                              opened) == 'door_open_v'
    # a different door's channel is not this door
    assert border_exit_sprite(('locked', 'red', 'border_door_9'), 'h',
                              opened) == 'door_red_h'
...
def test_border_sprite_gated_tracks_channel():
    ...
    assert border_exit_sprite(rec, 'h', {'some_other_gate'}) == 'gate_closed_h'
