...
Reference documentation for the original Turbo Pascal 7 source files kept in this repo. These files are **not compiled or run** — they serve as design reference for mechanics, level layouts, and the spiritual remake UGLYCRAFT.
