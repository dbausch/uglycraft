...
- [x] `TItemData` record type declared (`Ch`, `Name`, `Fg` fields)
- [x] `ItemDescFg`, `ItemDescBg`, `ItemCount` constants added
- [x] `Items : array[1..ItemCount] of TItemData` typed constant defined
- [x] `DrawItem` rewritten to use `Items` array
- [x] `ShowItemDescriptions` rewritten to use `Draw`; layout per spec below
...
- [x] `poe build-original` compiles with no errors or warnings (11e86d5)
- [x] `poe run-original` (11e86d5, 14ea528; confirmed by user):
